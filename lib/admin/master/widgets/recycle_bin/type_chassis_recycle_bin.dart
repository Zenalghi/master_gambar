  ...
  Future<void> _fetchTrash() async {
    ...
    try {
      final data = await ref
          ...
          .getDeletedTypeChassis(search: _searchQuery); // Kirim search query
      if (mounted) {
        setState(() {
          _deletedItems = data;
          _isLoading = false;
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
          ...
          'Data yang masih digunakan di Master Data/Kelistrikan tidak akan dihapus.',
        ),
        actions: [
          TextButton(
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Row(
        ...
        children: [
          const Text('Recycle Bin - Type Chassis'),
          // --- SEARCH BAR ---
          SizedBox(
            width: 200,
            height: 35,
